...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] cursor-pointer bg-white p-5 rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg" onClick={handleClick}>
